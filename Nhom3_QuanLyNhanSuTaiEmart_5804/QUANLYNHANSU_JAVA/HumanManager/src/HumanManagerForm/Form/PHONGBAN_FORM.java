 ...
 * @author vongh
 */
public class PHONGBAN_FORM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PHONGBAN_FORM
     */
    ...
    private void DesignTalbe() {
        tblpb.getTableHeader().setFont(new Font("Quicksand light", Font.BOLD, 14));
        tblpb.getTableHeader().setOpaque(false);
        tblpb.getTableHeader().setBackground(new Color(32, 136, 203));
    ...
    public void Loadulieu() {
        ...
        try {
            tblpb.removeAll();
            String[] arr = {"Mã phòng ban", "Tên phòng ban", "số điện thoại"};
            ...
            while (rs.next()) {
                String[] row = new String[]{
                    rs.getString("MAPB"), rs.getString("TENPB"), rs.getString("SDTPB")};
                tbtModel.addRow(row);
            }
            tblpb.setModel(tbtModel);
            tbtModel.fireTableDataChanged();
            tren = tblpb.getRowCount();
    ...
    private void initComponents() {
        ...
        txtmapb.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        txtmapb.setPreferredSize(new java.awt.Dimension(7, 25));

        txttenpb.setFont(new java.awt.Font("Quicksand Light", 1, 14)); // NOI18N
        txttenpb.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        txttenpb.setPreferredSize(new java.awt.Dimension(7, 25));

        jLabel5.setFont(new java.awt.Font("Quicksand Light", 1, 14)); // NOI18N
        jLabel5.setText("Số điện thoại:");

        txtsdt.setFont(new java.awt.Font("Quicksand Light", 1, 14)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtmapb, javax.swing.GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
                    .addComponent(txttenpb, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tblpb.setFont(new java.awt.Font("Quicksand Light", 1, 14)); // NOI18N
        ...
        tblpb.setRowHeight(25);
        tblpb.setSelectionBackground(new java.awt.Color(255, 204, 0));
        tblpb.setSelectionForeground(new java.awt.Color(0, 0, 0));
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
        ...
        int dk = JOptionPane.showConfirmDialog(this, "Bạn muốn xóa phòng ban này?", "Thông báo", JOptionPane.YES_NO_OPTION);
        if (dk == JOptionPane.YES_OPTION) {
            try {
                PhongBanDAO pb = new PhongBanDAO();
                if (pb.Delete(txtmapb.getText())) {
                    JOptionPane.showMessageDialog(this, "Xóa phòng ban thành công.");
                } else {
                    JOptionPane.showMessageDialog(this, "Xóa phòng ban thất bại.");
                }
                Loadulieu();
            } catch (Exception e) {
    ...
    private void btncnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncnActionPerformed
        ...
        try {
            ...
            PhongBanDAO tk = new PhongBanDAO();
            tk.Update(pb);
    ...
    private void btnluuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnluuActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Thêm phòng ban không thành công!");
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
        }
    }//GEN-LAST:event_btnluuActionPerformed
    private void SuKien() {
        txtmapb.setText(tblpb.getValueAt(duoi - 1, 0).toString());
        txttenpb.setText(tblpb.getValueAt(duoi - 1, 1).toString());
        txtsdt.setText(tblpb.getValueAt(duoi - 1, 2).toString());
    }
    private void btnsauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsauActionPerformed
        ...
        duoi += 1;
        lblDong.setText(duoi + "/" + tren);
        tblpb.setRowSelectionInterval(duoi - 1, duoi - 1);
        SuKien();
    ...
    private void btndauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndauActionPerformed
        // TODO add your handling code here:
        tblpb.setRowSelectionInterval(0, 0);
        duoi = 1;
        lblDong.setText(duoi + "/" + tren);
        SuKien();
    ...
    private void btncuoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncuoiActionPerformed
        // TODO add your handling code here:
        tblpb.setRowSelectionInterval(tren - 1, tren - 1);
        duoi = tren;
        lblDong.setText(duoi + "/" + tren);
        SuKien();
    ...
    private void btntimkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntimkiemActionPerformed
        ...
        try {
            PhongBanDAO pb = new PhongBanDAO();
            PhongBAn PB = pb.Search(txttimkiem.getText());
            if (PB != null) {
                ...
                JOptionPane.showMessageDialog(this, "Mã phòng ban không được tìm thấy!");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
    ...
    private void tblpbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpbMouseClicked
        ...
        if (row >= 0) {
            duoi = row + 1;
            lblDong.setText(duoi + "/" + tren);
            txtmapb.setText(tblpb.getValueAt(row, 0).toString());
            txttenpb.setText(tblpb.getValueAt(row, 1).toString());
            txtsdt.setText(tblpb.getValueAt(row, 2).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PHONGBAN_FORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PHONGBAN_FORM().setVisible(true);
            }
        });
    }
